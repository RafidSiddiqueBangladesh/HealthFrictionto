    ...
    <section className="relative py-16 lg:py-20 lg:min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg lg:text-lg max-w-full lg:max-w-lg mb-4 leading-relaxed font-light">
          ...
          <p className="text-muted-foreground text-sm sm:text-base lg:text-base max-w-full lg:max-w-lg mb-8 leading-relaxed font-light italic border-l-2 border-accent pl-4">
            <span className="font-semibold text-accent">Built for meaningful effort, not effortless health.</span> We challenge the assumption that all friction is bad. Our system introduces intentional friction through real-time exercise validation, health analytics, and manual tracking—forcing conscious engagement. Yet we remove friction entirely in critical moments like emergency access.
          </p>

          <div className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-accent/10 border border-accent/30 mb-8">
            <span className="text-sm font-bold text-accent">💡 Core Concept:</span>
            <span className="text-sm text-accent font-semibold">"In NutriCare, effort is the API."</span>
          </div>
